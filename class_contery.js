export class Contery{
    ...
    render(){
        ...
        div.innerHTML= `
        <div class="col-12">
        <img class="col-6 m-5 float-start" src="${this.svg}" alt="flag">
        <div class="col-6 mt-5 float-end">
        <h2>${this.common}</h2>
        ...
        <iframe class="col-6 m-5" src="https://maps.google.com/maps?q=${this.latlng}&z=7&output=embed"width="300" height="350" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade" floar-start m-2></iframe>
        <h5 class="col-4 mt-5 float-end">States with borders:<span>
        <div class="b_d"></div>
        </span></h5>
